...
{  
  public string[] Lenguajes => new[] { "C#", "Python", "C++", "SQL" };  
  public string Framework => ".NET";  
  public string[] Herramientas => new[] { "Visual Studio", "Git", "GitHub", "WordPress" };  
...
🔋 Semiconductores: Estudiando la lógica física detrás del hardware en el diplomado de electromovilidad del CENEM.

📚 Estructuras de Datos: Creando retos visuales en C# para que mis alumnos entiendan de una vez por todas cómo funciona una Pila vs una Cola.

🤝 **Conectemos**

Si estás buscando una desarrolladora Junior con un pensamiento lógico estructurado, facilidad para explicar procesos y muchas ganas de aportar al equipo, ¡escríbeme!
